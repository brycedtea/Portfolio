  ...
  return (
    ...
    <section id='socials' className='socials-wrapper'>
      ...
      <div className='socials'>
          <div>
          <a href='https://www.instagram.com/brycedtea/?hl=en' target='_blank'>
          <img className='icon1' src={instagram} alt='instagram icon'/>
          </a>
          <a href='https://www.linkedin.com/in/bryce-alvir-11b131184/' target='_blank'>
          <img className='icon2' src={linkedin} alt='linkedin icon' />
          </a>
          <a href='https://discord.com/users/brycedtea#0054' target='_blank'>
